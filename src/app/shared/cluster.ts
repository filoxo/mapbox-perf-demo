...
export class ClusterManager {
    ...
    public addNode(lngLat: number[], obj: any) {
    ...
    public getClusters(level: number): Cluster[] {
        ...
        const results: Cluster[] = clusters.map(cluster => ({
    ...
    private dist(lngLat1: number[], lngLat2: number[]): number {
